...
bool CProgramDatabase::CreateTables()
{
  ...
  try
  {
    ...
    m_pDS->exec("CREATE TABLE files ( idFile integer primary key, strFilename text, titleId integer, xbedescription text, iTimesPlayed integer, lastAccessed integer, iRegion integer, iSize integer, developer text, publisher text, features_general text, features_online text, esrb text, esrb_descriptors text, genre text, release_date text, rating text, platform text, exclusive text, synopsis text)\n");
...
CStdString CProgramDatabase::GetSynopsisOverview(const CStdString& strFilenameAndPath)
{

  CStdString strSQL;
  try
  {	
    strSQL = PrepareSQL("select * from files where files.strFileName like '%s'", strFilenameAndPath.c_str());
    if (!m_pDS->query(strSQL.c_str()))
      return "";

    CStdString Output = m_pDS->fv("files.synopsis").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisOverview(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisDeveloper(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.developer").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisDeveloper(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisPublisher(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.publisher").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisPublisher(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisFeaturesGeneral(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.features_general").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisFeaturesGeneral(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisFeaturesOnline(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.features_online").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisFeaturesOnline(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisESRB(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.esrb").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisESRB(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisESRBDescriptors(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.esrb_descriptors").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisESRBDescriptors(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisGenre(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.genre").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisGenre(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisReleaseDate(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.release_date").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisReleaseDate(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisRating(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.rating").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisRating(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisPlatform(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.platform").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisPlatform(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}

CStdString CProgramDatabase::GetSynopsisExclusive(const CStdString& strFilenameAndPath)
{
  ...
  {	
    ...
    CStdString Output = m_pDS->fv("files.exclusive").get_asString();
	return Output;
  }
  catch (...)
  {
    CLog::Log(LOGERROR, "CProgramDatabase:GetSynopsisExclusive(%s) Failed",strFilenameAndPath.c_str());
  }
  return "";
}
...
bool CProgramDatabase::AddProgramInfo(CFileItem *item, unsigned int titleID)
{
  try
  {
	...
	// Get synopsis title for synopsis if found and the settings is enabled
	int synopsisparsing = g_guiSettings.GetBool("mygames.gamesynopsisinfo");
	...
	if (synopsisparsing)
	{
		...
		URIUtils::GetDirectory(item->GetPath(),strPath);
		URIUtils::AddFileToFolder(strPath,"_resources\\default.xml",strPath);
		if (CFile::Exists(strPath))
		{
			TiXmlDocument xml_path_load;
			xml_path_load.LoadFile(strPath);
    ...
    CStdString strSQL=PrepareSQL("insert into files (idFile, strFileName, titleId, xbedescription, iTimesPlayed, lastAccessed, iRegion, iSize, developer, publisher, features_general, features_online, esrb, esrb_descriptors, genre, release_date, rating, platform, exclusive, synopsis) values(NULL, '%s', %u, '%s', %i, %I64u, %i, %I64u, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
				item->GetPath().c_str(), titleID, item->GetLabel().c_str(), 0, lastAccessed.QuadPart, iRegion, iSize, developer.c_str(), publisher.c_str(), features_general.c_str(), features_online.c_str(), esrb.c_str(), esrb_descriptors.c_str(), genre.c_str(), release_date.c_str(), rating.c_str(), platform.c_str(), exclusive.c_str(), synopsis.c_str());
