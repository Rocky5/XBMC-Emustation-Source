...
public:
  ...
  CStdString GetSynopsisOverview(const CStdString& strPathAndFilename);
  CStdString GetSynopsisDeveloper(const CStdString& strPathAndFilename);
  CStdString GetSynopsisPublisher(const CStdString& strPathAndFilename);
  CStdString GetSynopsisFeaturesGeneral(const CStdString& strPathAndFilename);
  CStdString GetSynopsisFeaturesOnline(const CStdString& strPathAndFilename);
  CStdString GetSynopsisESRB(const CStdString& strPathAndFilename);
  CStdString GetSynopsisESRBDescriptors(const CStdString& strPathAndFilename);
  CStdString GetSynopsisGenre(const CStdString& strPathAndFilename);
  CStdString GetSynopsisReleaseDate(const CStdString& strPathAndFilename);
  CStdString GetSynopsisRating(const CStdString& strPathAndFilename);
  CStdString GetSynopsisPlatform(const CStdString& strPathAndFilename);
  CStdString GetSynopsisExclusive(const CStdString& strPathAndFilename);
