...
#define LISTITEM_SYNOPSISOVERVIEW       		(LISTITEM_START + 62)
#define LISTITEM_SYNOPSISDEVELOPER      		(LISTITEM_START + 63)
#define LISTITEM_SYNOPSISPUBLISHER       		(LISTITEM_START + 64)
#define LISTITEM_SYNOPSISFEATURES_GENERAL       (LISTITEM_START + 65)
#define LISTITEM_SYNOPSISFEATURES_ONLINE        (LISTITEM_START + 66)
#define LISTITEM_SYNOPSISESRB      				(LISTITEM_START + 67)
#define LISTITEM_SYNOPSISESRB_DESCRIPTORS       (LISTITEM_START + 68)
#define LISTITEM_SYNOPSISGENRE      			(LISTITEM_START + 69)
#define LISTITEM_SYNOPSISRELEASE_DATE     		(LISTITEM_START + 70)
#define LISTITEM_SYNOPSISRATING      			(LISTITEM_START + 71)
#define LISTITEM_SYNOPSISPLATFORM       		(LISTITEM_START + 72)
#define LISTITEM_SYNOPSISEXCLUSIVE       		(LISTITEM_START + 73)
